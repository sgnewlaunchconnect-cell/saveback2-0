-- Add redemptions column to deals table to track completed redemptions
ALTER TABLE deals ADD COLUMN redemptions integer DEFAULT 0;

-- Create function to get deal statistics for urgency indicators
